...
inline void calc_grain_size_increment_1d (
  ...
  FORTRAN_NAME(calc_grain_size_increment_1d)(
    ...
    my_rates->opaque_storage->inject_pathway_props->size_moments.data[OnlyGrainSpLUT::SiM_dust],
    my_rates->opaque_storage->inject_pathway_props->size_moments.data[OnlyGrainSpLUT::FeM_dust],
    my_rates->opaque_storage->inject_pathway_props->size_moments.data[OnlyGrainSpLUT::Mg2SiO4_dust],
    my_rates->opaque_storage->inject_pathway_props->size_moments.data[OnlyGrainSpLUT::MgSiO3_dust],
    my_rates->opaque_storage->inject_pathway_props->size_moments.data[OnlyGrainSpLUT::Fe3O4_dust],
    my_rates->opaque_storage->inject_pathway_props->size_moments.data[OnlyGrainSpLUT::AC_dust],
    my_rates->opaque_storage->inject_pathway_props->size_moments.data[OnlyGrainSpLUT::SiO2_dust],
    my_rates->opaque_storage->inject_pathway_props->size_moments.data[OnlyGrainSpLUT::MgO_dust],
    my_rates->opaque_storage->inject_pathway_props->size_moments.data[OnlyGrainSpLUT::FeS_dust],
    my_rates->opaque_storage->inject_pathway_props->size_moments.data[OnlyGrainSpLUT::Al2O3_dust],
    ...
    my_rates->opaque_storage->inject_pathway_props->opacity_coef_table.data[OnlyGrainSpLUT::MgSiO3_dust],
    my_rates->opaque_storage->inject_pathway_props->opacity_coef_table.data[OnlyGrainSpLUT::Fe3O4_dust],
    my_rates->opaque_storage->inject_pathway_props->opacity_coef_table.data[OnlyGrainSpLUT::AC_dust],
    my_rates->opaque_storage->inject_pathway_props->opacity_coef_table.data[OnlyGrainSpLUT::SiO2_dust],
    my_rates->opaque_storage->inject_pathway_props->opacity_coef_table.data[OnlyGrainSpLUT::MgO_dust],
    my_rates->opaque_storage->inject_pathway_props->opacity_coef_table.data[OnlyGrainSpLUT::FeS_dust],
    my_rates->opaque_storage->inject_pathway_props->opacity_coef_table.data[OnlyGrainSpLUT::Al2O3_dust],
    my_rates->opaque_storage->inject_pathway_props->opacity_coef_table.data[OnlyGrainSpLUT::ref_org_dust],
    my_rates->opaque_storage->inject_pathway_props->opacity_coef_table.data[OnlyGrainSpLUT::vol_org_dust],
    my_rates->opaque_storage->inject_pathway_props->opacity_coef_table.data[OnlyGrainSpLUT::H2O_ice_dust],
